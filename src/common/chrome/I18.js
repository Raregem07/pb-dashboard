...
const localTranslations = {
  ...
  "post_fetching_status_tooltip": {
    "message": "Used in automation. If circle is rotating, then ProfileMate is fetching posts and users for automation based on the criteria you set"
  },
  "dead_followers": {
  ...
  "trial_over_message":  {
    "message": "ProfileMate Subscription Expired. Buy ProfileMate to keep sky rocketing your growth"
  },
  "analytics_trial_over_message": {
    "message": "ProfileMate \"Analytics\" Subscription Expired. Buy ProfileMate to keep using analytics and sky rocket your growth"
  },
  "engage_trial_over_message": {
    "message": "ProfileMate \"Targeted Engagemenet\" Subscription Expired. Buy ProfileMate to keep using targeted engagement and sky rocket your growth"
  },
  "split_image": {
    "message": "Split Image"
  },
