...
async function getLocationPosts(locationPK, nextPage = null) {
  ...
  try {
    ...
    // console.log(e.response.status, 'Class: getHashtagPosts, Function: , Line 34 e.response.status(): ');
    ...
    return { posts: [], nextPageToken: null, topPosts: [] };
  }
