...
import CommenterUser from "../../models/CommenterUser";

async function getCommentersOfAPost(postShortCode, nextPageToken = null, throwError = false) {
  ...
  for (let i = 0; i < edges.length; i++) {
    users.push(new CommenterUser(edges[i]));
  }
...
export default getCommentersOfAPost;
